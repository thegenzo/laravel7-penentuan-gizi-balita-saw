...
@section('title', 'SPKBalita | Data Indeks Massa Tubuh menurut Umur')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Data Indeks Massa Tubuh menurut Umur (IMT /U)</h1>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <a href="{{ url('/imtu/create') }}" class="btn btn-info float-right mb-2">Tambah Data</a>
                                <table id="tableData" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="text-center" rowspan="2">Umur (bulan)</th>
                                            <th class="text-center" colspan="7">Indeks Massa Tubuh (IMT)</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody>
                                        @foreach ($imtu as $data)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="/imtu/{{ $data->id }}/edit" class="btn btn-warning">
                                                        <i class="nav-icon fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('imtu.destroy', $data->id) }}" method="POST"
