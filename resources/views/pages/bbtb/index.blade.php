...
@section('title', 'SPKBalita | Data Berat Badan Menurut Tinggi Badan')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Data Berat Badan Menurut Tinggi Badan (BB /TB)</h1>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <a href="{{ url('/bbtb/create') }}" class="btn btn-info float-right mb-2">Tambah Data</a>
                                    ...
                                    <tbody>
                                        @foreach ($bbtb as $data)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="/bbtb/{{ $data->id }}/edit" class="btn btn-warning">
                                                        <i class="nav-icon fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('bbtb.destroy', $data->id)}}" method="POST" class="d-inline" onsubmit="return confirm('Yakin Hapus Data?')">
                                                        @csrf
                                                        @method('DELETE')
