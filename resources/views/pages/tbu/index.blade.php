                                    ...
                                    <tbody>
                                        @foreach ($tbu as $data)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="/tbu/{{ $data->id }}/edit" class="btn btn-warning">
                                                        <i class="nav-icon fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('tbu.destroy', $data->id)}}" method="POST" class="d-inline" onsubmit="return confirm('Yakin Hapus Data?')">
                                                        @csrf
                                                        @method('DELETE')
